...
import cn.gdeiassistant.Activity.GuideActivity;
...
import cn.gdeiassistant.Model.GuideModel;
import cn.gdeiassistant.Service.UpgradeService;
import cn.gdeiassistant.Tools.NetWorkUtils;
...
public class GuidePresenter {
    ...
    private void Init() {
        ...
        if (receiver == null) {
            ...
            //注册广播监听
            guideActivity.registerReceiver(receiver, new IntentFilter("cn.gdeiassistant.CHECK_UPGRADE"));
        }
        //WIFI状态下启动检测更新服务
