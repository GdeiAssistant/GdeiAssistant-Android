...
import cn.gdeiassistant.Activity.WebViewActivity;
...
import cn.gdeiassistant.Model.LoginModel;
...
public class LoginPresenter {
    ...
    private void Init() {
        ...
        if (receiver == null) {
            ...
            //注册广播监听
            loginActivity.registerReceiver(receiver, new IntentFilter("cn.gdeiassistant.CHECK_UPGRADE"));
        }
    }
    ...
    public void ShowAgreement() {
        ...
        intent.putExtra("title", "广东二师助手用户协议");
        intent.putExtra("url", loginActivity.getApplicationContext().
                getString(R.string.resource_domain) + "agreement");
    ...
    public void ShowPrivacyPolicy() {
        Intent intent = new Intent(loginActivity, WebViewActivity.class);
        intent.putExtra("title", "广东二师助手隐私政策");
        intent.putExtra("url", loginActivity.getApplicationContext().getString(R.string.resource_domain) + "policy/privacy");
        loginActivity.startActivity(intent);
    }
