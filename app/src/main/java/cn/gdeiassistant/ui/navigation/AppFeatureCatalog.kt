...
object AppFeatureCatalog {
    ...
    val features: List<AppFeature> = listOf(
        // ── 校园服务（严格按 iOS 顺序） ──
        AppFeature(Routes.GRADE, R.string.menu_grade, R.string.feature_grade_subtitle, Icons.Rounded.School, AppFeatureGroup.SERVICE),
        AppFeature(Routes.SCHEDULE, R.string.menu_schedule, R.string.feature_schedule_subtitle, Icons.Rounded.CalendarMonth, AppFeatureGroup.SERVICE),
        ...
        // ── 校园生活（严格按 iOS 顺序） ──
        AppFeature(Routes.MARKETPLACE, R.string.marketplace_title, R.string.feature_marketplace_subtitle, Icons.Rounded.Storefront, AppFeatureGroup.LIFE),
        AppFeature(Routes.DELIVERY, R.string.delivery_title, R.string.feature_delivery_subtitle, Icons.Rounded.LocalShipping, AppFeatureGroup.LIFE),
        AppFeature(Routes.LOST_FOUND, R.string.lost_found_title, R.string.feature_lost_found_subtitle, Icons.Rounded.FindInPage, AppFeatureGroup.LIFE),
        AppFeature(Routes.SECRET, R.string.secret_title, R.string.feature_secret_subtitle, Icons.Rounded.Campaign, AppFeatureGroup.LIFE),
        AppFeature(Routes.DATING, R.string.dating_title, R.string.feature_dating_subtitle, Icons.Rounded.People, AppFeatureGroup.LIFE),
        AppFeature(Routes.EXPRESS, R.string.express_title, R.string.feature_express_subtitle, Icons.Rounded.AllInbox, AppFeatureGroup.LIFE),
        AppFeature(Routes.TOPIC, R.string.topic_title, R.string.feature_topic_subtitle, Icons.Rounded.Tag, AppFeatureGroup.LIFE),
        AppFeature(Routes.PHOTOGRAPH, R.string.photograph_title, R.string.feature_photograph_subtitle, Icons.Rounded.PhotoCamera, AppFeatureGroup.LIFE)
    )
