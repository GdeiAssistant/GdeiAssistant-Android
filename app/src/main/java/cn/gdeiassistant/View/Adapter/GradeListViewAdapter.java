...
public class GradeListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            listItemView.item_layout = convertView.findViewById(cn.gdeiassistant.R.id.grade_item_layout);
            listItemView.subject_name = convertView.findViewById(cn.gdeiassistant.R.id.grade_item_subjectname);
            listItemView.subject_score = convertView.findViewById(cn.gdeiassistant.R.id.grade_item_subjectscore);
            //设置控件集到convertView
