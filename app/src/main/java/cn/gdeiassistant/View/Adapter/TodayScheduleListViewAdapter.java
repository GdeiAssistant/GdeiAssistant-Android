...
public class TodayScheduleListViewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            listItemView.itemLayout = convertView.findViewById(cn.gdeiassistant.R.id.todayScheduleItemLayout);
            listItemView.dividerLine = convertView.findViewById(cn.gdeiassistant.R.id.todayScheduleItemDividerline);
            listItemView.scheduleTime = convertView.findViewById(cn.gdeiassistant.R.id.todayScheduleItemScheduleTime);
            listItemView.scheduleName = convertView.findViewById(cn.gdeiassistant.R.id.todayScheduleItemScheduleName);
            listItemView.scheduleLocation = convertView.findViewById(cn.gdeiassistant.R.id.todayScheduleItemScheduleLocation);
            //设置控件集到convertView
