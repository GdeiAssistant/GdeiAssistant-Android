...
public class CardListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            listItemView.item_layout = convertView.findViewById(cn.gdeiassistant.R.id.cardItemLayout);
            listItemView.card_item_tradename = convertView.findViewById(cn.gdeiassistant.R.id.cardItemTradeName);
            listItemView.card_item_tradeprice = convertView.findViewById(cn.gdeiassistant.R.id.cardItemTradePrice);
            listItemView.card_item_tradetime = convertView.findViewById(cn.gdeiassistant.R.id.cardItemTradeTime);
            listItemView.card_item_tradeaccountbalance = convertView.findViewById(cn.gdeiassistant.R.id.cardItemTradeAccountBalance);
            listItemView.divider_line = convertView.findViewById(cn.gdeiassistant.R.id.cardItemDividerLine);
            //设置控件集到convertView
