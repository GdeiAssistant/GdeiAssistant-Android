...
public class GridViewDateAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(cn.gdeiassistant.R.layout.item_gridview_date, null);
            viewHolder.textViewDate = convertView.findViewById(cn.gdeiassistant.R.id.textviewDate);
