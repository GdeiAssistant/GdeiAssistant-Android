...
public class ListViewNumberAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(cn.gdeiassistant.R.layout.item_listview_number, null);
            viewHolder.textViewNumber = convertView.findViewById(cn.gdeiassistant.R.id.textviewNumber);
