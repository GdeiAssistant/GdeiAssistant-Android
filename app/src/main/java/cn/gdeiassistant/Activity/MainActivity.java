package cn.gdeiassistant.Activity;
...
import cn.gdeiassistant.Constant.ChangeAvatarOptionConstant;
import cn.gdeiassistant.Constant.MainItemTagConstant;
import cn.gdeiassistant.Constant.PermissionRequestCodeConstant;
import cn.gdeiassistant.Fragment.FragmentCet;
import cn.gdeiassistant.Fragment.FragmentGrade;
import cn.gdeiassistant.Fragment.FragmentIndex;
import cn.gdeiassistant.Fragment.FragmentSchedule;
import cn.gdeiassistant.Pojo.Entity.Access;
import cn.gdeiassistant.Presenter.MainPresenter;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    public void ShowRequestCameraPermissionDialog(final int requestCode) {
        ...
        builder.setTitle("申请拍照或录像的权限").setCancelable(false)
                .setMessage("广东二师助手需要获取拍照或录像的权限，用于拍照和上传头像")
    ...
    public void ShowRequestStoragePermissionDialog(final int requestCode) {
        ...
        builder.setTitle("申请读写手机存储的权限").setCancelable(false)
                .setMessage("广东二师助手需要获取读写手机存储的权限，用于加载用户头像信息")
                .setPositiveButton("好", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        //申请存储权限
